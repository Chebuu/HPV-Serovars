...
gA <- system.file('GroupA.fasta', 'HPVSerovars') # Highest risk
gB <- system.file('GroupB.fasta', 'HPVSerovars') # Other high risk
gC <- system.file('GroupC.fasta', 'HPVSerovars') # Probably high risk
```
