...
```{r risk_groups}
# Genital cancer risk groups
gA <- Biostrings::readDNAStringSet('inst/extdata/GroupA.fasta') 
# system.file('GroupA.fasta', 'HPVSerovars') # Highest risk
gB <- Biostrings::readDNAStringSet('inst/extdata/GroupB.fasta') 
# system.file('GroupB.fasta', 'HPVSerovars') # Other high risk
gC <- Biostrings::readDNAStringSet('inst/extdata/GroupC.fasta') 
# system.file('GroupC.fasta', 'HPVSerovars') # Probably high ris
